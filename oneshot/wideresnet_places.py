...
class ATTResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, num_attributes=1000):
        self.inplanes = 64
        ...
        self.fc_attribute = nn.Linear(512 * block.expansion, num_attributes)
